...
public class CSV { 
	...
	private static int lineasCSV = 0; //Lineas del CSV
...
//		Lo meto dentro de un try-catch para que sea posible probar la parte de estructura de datos en un main sin tener que usar ventanas
		try {
			VentanaCargaCSV.incPB();
//			VentanaCargaCSV.printInTA(numLinea + "\t" + datos); //Comento esta linea porque me da un error de Java heap space cuando la ejecuto con el archivo de 40000 lineas
		} catch (Exception e) {
			// TODO: handle exception
			System.out.println(numLinea + "\t" + datos);
		}
		
	}
	
	public static int countCSVLines(File file) {
        int lineCount = 0;
        ...
        return lineCount-1; //No cuento la linea de la Cabecera   
    }
